...
export default function Home() {
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={`${styles.left} fade-aside-in`} style={{ transitionDuration: '500ms' }}>
        <div>
          {Contacts.map((contact) => 
            !(contact.name === 'ojo.oluwatosin.adebayo@gmail.com' || contact.name === 'WhatsApp') &&
      ...
      <div className={`${styles.right} fade-aside-in`} style={{ transitionDuration: '500ms' }}>
        <div>
          {Contacts.map((contact) => 
