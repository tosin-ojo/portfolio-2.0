...
const About = () => {
    ...
    useEffect(() => {
        ...
        document.querySelector('#about-experience-p').innerHTML = AboutInfo.experience
        document.querySelector('#about-achievement-p').innerHTML = AboutInfo.achievement
    })
        ...
        <section id="about" className={styles.about}>
            ...
            <div className={styles.info}>
                ...
                <div className={styles.right}>
                    ...
                    <p id="about-experience-p">
                    </p>
                    <span>
                        &nbsp;&nbsp;{`</p>`}<br /><br />
                        &nbsp;&nbsp;{`<p class="achievement">`}
                    </span>
                    <p id="about-achievement-p">
                    </p>
                    <span>
                        &nbsp;&nbsp;{`</p>`}<br />
                        {`</html>`}
