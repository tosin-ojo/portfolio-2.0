...
export const AboutInfo = {
  ...
  experience:
    'Over the years, I have built <a href="#projects">self-pleasing and client-satisfying projects</a>, and I am also privileged to work with a creative team to build, deploy and maintain fascinating web solutions.',
  achievement:
    'Recently, I rendered a full-stack service to an organization to build a <a href="#" traget="_blank">world-class solution</a>, hence, providing a global reach.',
  technologies: [
    {
      name: "JavaScript",
      icon: <Javascript />,
